...
# NOTE: Uncomment tasks as task modules are created in respective apps
app.conf.beat_schedule = {
    # Example tasks (disabled until task modules exist):
    # 'sync-results': {
...
# Task routing
# Enable queues as task modules are created:
